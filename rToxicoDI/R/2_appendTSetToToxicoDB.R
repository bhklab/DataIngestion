...
appendTSetToToxicoDB <- function(tables, lab_tables, lab_tSet, lab_out) {
  ...
  ## Species table; no overlap so easy
  ...
  ## Species
  ## TODO:: Finish implementing cell id replacement base don tSet2 values
  ...
  ) { stop('Issue with viabilities table mappings!') } else {
